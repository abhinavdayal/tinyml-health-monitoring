...
noisy_image = SD_Attribute + 0.5 * np.random.randn(*SD_Attribute.shape)  # Add some Gaussian noise
...
SD_model.fit(NASnet_Features,Label)
# SD_model.save_model('Stress_Detection_model_98.h5')
